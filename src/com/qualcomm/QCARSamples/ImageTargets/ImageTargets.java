...
mTextures.add(Texture.loadTextureFromApk("new0.jpg", getAssets()));

mTextures.add(Texture.loadTextureFromApk("new1.png", getAssets()));

mTextures.add(Texture.loadTextureFromApk("new2.png", getAssets()));

mTextures.add(Texture.loadTextureFromApk("new3.png", getAssets()));

mTextures.add(Texture.loadTextureFromApk("new4.png", getAssets()));

mTextures.add(Texture.loadTextureFromApk("new5.png", getAssets()));

mTextures.add(Texture.loadTextureFromApk("new6.png", getAssets()));

mTextures.add(Texture.loadTextureFromApk("new7.png", getAssets()));

mTextures.add(Texture.loadTextureFromApk("new8.png", getAssets()));

mTextures.add(Texture.loadTextureFromApk("new9.png", getAssets()));

mTextures.add(Texture.loadTextureFromApk("new10.png", getAssets()));

mTextures.add(Texture.loadTextureFromApk("new11.png", getAssets()));
    }
