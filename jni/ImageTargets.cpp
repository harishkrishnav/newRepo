...
Java_com_qualcomm_QCARSamples_ImageTargets_ImageTargets_loadTrackerData(JNIEnv *, jobject)
{
    ...
    // Load the data sets:
    if (!dataSetStonesAndChips->load("RestoringLens.xml", QCAR::STORAGE_APPRESOURCE))
    {
...
Java_com_qualcomm_QCARSamples_ImageTargets_ImageTargetsRenderer_renderFrame(JNIEnv *, jobject)
{
    ...
    for(int tIdx = 0; tIdx < state.getNumTrackableResults(); tIdx++)
    {
        ...
        if (strcmp(trackable.getName(), "old0") == 0) {
        	textureIndex = 0;
			b=85;
			l=85/2;
			updateVertices();
        } else if (strcmp(trackable.getName(), "old1") == 0) {
        	textureIndex = 1;
			b=(1000.0/512)*85;
			l=(557.0/512)*85*2;
			rat=1.0;
			updateVertices();
        	//rat = 1000/512;
        } else if (strcmp(trackable.getName(), "old2") == 0) {
        	textureIndex = 2;
			b=(768.0/512)*85;
			l=(549.0/512)*85*2;
			rat = (549/768.0)*0.75;
        ...
        } else if (strcmp(trackable.getName(), "old3") == 0) {
        	textureIndex = 3;
			b=(725.0/512)*85;
			l=(1000.0/512)*85*2;
			//rat = 725/1000;
        ...
        } else if (strcmp(trackable.getName(), "old4") == 0) {
        	textureIndex = 4;
			b=(589.0/512)*85;
			l=(800.0/512)*85*2;
			rat = 589.0/800;
		...
		else if (strcmp(trackable.getName(), "old5") == 0) {
        	textureIndex = 5;
			b=(704.0/512)*85;
			l=(1052.0/512)*85*2;
			rat=1.0;
		...
		else if (strcmp(trackable.getName(), "old6") == 0) {
        	textureIndex = 6;
			b=(649.0/512)*85;
			l=(867.0/512)*85*2;
			rat=(649.0/867.0)*1.1;  
		...
		else if (strcmp(trackable.getName(), "old7") == 0) {
        	textureIndex = 7;
			b=(399.0/512)*85;
			l=(509.0/512)*85*2;
			rat=(399.0/509.0)*0.65; 
			updateVertices();
        }
		
		else if (strcmp(trackable.getName(), "old8") == 0) {
        	textureIndex = 8;
			b=(670.0/512)*85;
			l=(830.0/512)*85*2;
			rat=0.85;
		...
		else if (strcmp(trackable.getName(), "old9") == 0) {
        	textureIndex = 9;
			b=(710.0/512)*85;
			l=(1008.0/512)*85*2;
			rat=1.0;
		...
		else if (strcmp(trackable.getName(), "old10") == 0) {
        	textureIndex = 10;
			b=(598.0/512)*85;
			l=(1030.0/512)*85*2;
			rat=1.0;
		...
		else if (strcmp(trackable.getName(), "old11") == 0) {
        	textureIndex = 11;
			b = (708.0/512)*85;
			l = (964.0/512)*85*2;
			rat=1.0;
        ...
        teapotVertices[1] = -si*rat*2;
        teapotVertices[4] = -si*rat*2;
        teapotVertices[7] = si*rat*2;
        teapotVertices[10] = si*rat*2;
